...
<head>
	...
	<?php  if (is_page('Home')){ ?>
		...
		<link rel="stylesheet" href="<?php bloginfo('template_directory') ?>/custom-eixo/desktop/css/comp-diferenciaisteste.css">
	...
	<?php  if (is_page('Dicas da Bia')){ ?>
		...
		<link rel="stylesheet" href="<?php bloginfo('template_directory') ?>/custom-eixo/desktop/css/comp-newsletter.css">
	...
	<?php  if (is_single()){ ?>
		<link rel="stylesheet" href="<?php bloginfo('template_directory') ?>/custom-eixo/desktop/css/comp-newsletter.css">
		<link rel="stylesheet" href="<?php bloginfo('template_directory') ?>/custom-eixo/desktop/css/comp-paginador.css">
